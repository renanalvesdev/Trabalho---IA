 ...
 *
 */
public class RenanAgente1VacuumAgent extends VacuumAgent
{
    ...
    public void determineAction()
    {
		...
		else if (p.elementAt(2) == "home") // seria interessante aumentarmos as chances de forward aparecer.
		{
