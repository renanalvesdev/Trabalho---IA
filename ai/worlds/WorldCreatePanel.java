...
public class WorldCreatePanel extends JPanel implements ActionListener, ItemListener {
     ...
     */
    String[] vacuumStrings = {"Random Vacuum Agent", "Reactive Vacuum Agent", "Renan Agente1 Vacuum Agent", "Renan Agente2 Vacuum Agent"};
    /**
    ...
    private Agent createAgent(String agentName) {
    	...
    	else if (agentName == "Renan Agente1 Vacuum Agent") return new RenanAgente1VacuumAgent();
    	else if (agentName == "Renan Agente2 Vacuum Agent") return new RenanAgente2VacuumAgent();
